...
[[maybe_unused]] static std::string compile_opts()	{ return "-O1 -g -march=native -Wall -fno-exceptions -fno-rtti"; }
[[maybe_unused]] static std::string build_type()	{ return "Debug"; }
